  ...
  return (
    ...
    <View style={styles.container}>
      <View style={styles.exercise_container}>
        ...
        <ScrollView horizontal={false} style={styles.box} contentContainerStyle={{ alignItems: 'center', justifyContent: 'center', marginLeft: 15, }}
          refreshControl={
      ...
      <View style={styles.btn_box}>
            ...
            <KeyboardAwareScrollView bounces={false} keyboardOpeningTime={0} showsVerticalScrollIndicator={false} extraHeight={150} contentContainerStyle={{ flexGrow: 1, justifyContent: 'center' }}>
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  ...
                  <View style={[styles.inputView, { flexDirection: 'column', height: 435, width: '100%', marginBottom: 0, }]}>
                    <TextInput
                      style={[styles.input,
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              <Text style={[styles.modalText, { marginBottom: 0, height: 45, }]}>Comments:</Text>
        ...
        <TouchableOpacity
          style={[styles.btn_shape, styles.buttonClose, {backgroundColor: theme.colors.third, marginTop: 25}]}
